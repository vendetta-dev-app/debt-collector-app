  ...
  const [createPayment, { loading }] = useMutation(CreatePaymentMutation, {
    onCompleted: (data) => {
      if (data.createPayment?.payment) {
        ...
        toast('Se registró el pago correctamente!', 'success')
      }
    },
    onError: (err) => {
      ...
      await createPayment({
        variables: {
          input: {
            ...
            paymentDate: `${values.paymentDate}T00:00:00`,
      ...
      >
        ...
        >
          ...
          <div className="p-4">
            {/* Info Card */}
            <div
                className="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-3 mb-4">
                    ...
                    <div className="space-y-4">
                      ...
                      {values.amount && !errors.amount && (
                          <div
                            ...
                            <p className="text-xs text-green-600 dark:text-green-400 font-medium mb-1">Resumen del
                              Pago</p>
                            <div className="flex justify-between items-center">
                            ...
                            <div className="flex justify-between items-center mt-1">
                              <span className="text-xs text-green-700 dark:text-green-300">Nuevo balance
                                pendiente:</span>
